...
internal class SizeTest {
	...
	@Test fun `check conversion between metric and imperial dimensions`() {
		...
		assertThat(metricDimension.points).describedAs("metric and imperial dimensions are almost the same, given that 210mm is slightly different than 8.27 inches")
			.isCloseTo(expectedImperialDimension.points, Percentage.withPercentage(0.05))
	}
