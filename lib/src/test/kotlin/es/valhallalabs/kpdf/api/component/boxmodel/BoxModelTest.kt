...
internal class BoxModelTest {
	...
	@Test fun `test how paddings affects inner box model properties`() {
		...
		assertThat(a4BoxModel.width.points).isEqualTo(expectedA4BoxSizeWidthInPoints)
		assertThat(a4BoxModel.effectiveWidth.points).isEqualTo(expectedA4BoxSizeWidthInPoints - PageFormat.PAGE_BASE_A4.margins.horizontalMargin.points - paddingsSize * 2)
